...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    ...
    it is used to match the url exactly and get its related data

2. How would you explain form validation to someone who has never programmed before?

    form validation is a process that checks the UI and makes sure that a potential user cannot submit missing data, or data that does not meet the requirements

3. In 1-2 sentences, define end to end testing.

    End to end testing is an automated test that interacts with your page like a real user, and can validate if something is working properly.
